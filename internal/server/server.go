...
func (s *Server) Run() error {
	...
	mux.HandleFunc("/logs", s.HandleScanLogsPage)
	...
	mux.HandleFunc("/api/scan/events", s.HandleScanEvents)
	...
	mux.HandleFunc("/api/scan/disk-events", s.HandleDiskScanEvents)
	...
	mux.HandleFunc("/api/hash/events", s.HandleHashEvents)
